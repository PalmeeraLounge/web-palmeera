                            ...
                            <section class="page-title" style="background-image:url(images/background/bg-page-title-1.jpg);">
                                ...
                                <section class="page-info">
                                    <div class="auto-container clearfix">
                                        <div class="pull-left"><h2>Standard Lounge</h2></div>
                                        <div class="pull-right">
                                            <ul class="bread-crumb clearfix">
                                                <li><a href="index.php">Home</a></li>
                                                <li><a href="#">Pages</a></li>
                                                <li>Standard Lounge</li>
                                            </ul>
                                        </div>
                                    </div>
                                </section>
...
<div class="project-content">
    <div class="sidebar-title">
        <h3>Standard Lounge</h3>
    </div>
    <div class="row clearfix">
        <!--Content Column for Benefit Standard Lounge-->
        <div class="content-column col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <h3>Benefit Standard Lounge:</h3>
            <ol class="benefit-list">
                <li>1. Fasilitas ruang tunggu Lounge yang nyaman dengan kapasitas 1000 tempat duduk.</li>
                <li>2. Penggunaan ruang tunggu/lounge hingga 4 (empat) jam.</li>
                <li>3. Layanan makan perasmanan untuk Sarapan, Makan Siang maupun Makan Malam dengan 
                variasi hidangan yang lengkap.</li>
                <li>4. Penggunaan fasilitas WiFi secara cuma-Cuma.</li>
                <li>5. Area khusus untuk merokok.</li>
